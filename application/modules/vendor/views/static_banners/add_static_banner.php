          ...
          <div class="padd">
            ...
            <?php
                ...
                <div class="row">
                	<div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="static_banner_name" placeholder="Enter Title" value="<?php echo set_value("static_banner_name");?>">
                        </div>
                        <div class="form-group">
                            <label for="static_banner_description">Description</label>
                            <textarea class="form-control" name="static_banner_description"><?php echo set_value("static_banner_description");?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control fieldset__input js__datepicker" name="date_from" placeholder="Start Date">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control fieldset__input js__datepicker" name="date_to" placeholder="End Date">
                                </div>
                            </div>
                        </div>
                            	...
                            	<div class="col-md-9">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 300px; height: 150px;">
                                        	<img src="<?php echo $short_banner_location;?>" />
                                        </div>
                                        <div>
                            	...
                            	<div class="col-md-9">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 300px;">
                                        	<img src="<?php echo $long_banner_location;?>" />
                                        </div>
                                        <div>
				...
				<div class="form-group center-align">
					<input type="submit" value="Add Banner" class="login_btn btn btn-success btn-lg">
				</div>
				<?php
					form_close();
				?>
